...
def autofill_hms_tax_value(doc, method):
	...
	doc.hms_tax_value = value

def calculate_hms_tax_and_charges(base_total, hms_tax_id):
	# UPDATE: FOR NOW, THE OPTION OF TAX BREAKDOWN IS LIMITED TO ON NET TOTAL

	tax_breakdown_list = frappe.get_all('HMS Tax Breakdown', filters={'parent': hms_tax_id}, order_by="idx asc", fields=['*'])
