...
function generate_card() {
    frappe.call({
        method:'inn.hms_module.doctype.inn_membership_card.inn_membership_card.get_years_to_expire',
        callback: (r) => {
           let fields = [
               {
           ...
           d.set_primary_action(__('Generate'), ()=> {
               frappe.call({
                  method: 'inn.hms_module.doctype.inn_membership_card.inn_membership_card.generate_bulk_cards',
                  args: {
